...
<!-- start-smoth-scrolling -->
  ...
  <script type="text/javascript" language="javascript">
...

        {
            ...
            var ContctNopattern = /^[0-9]+$/;
            var Enrollpattern = /^[0-9]+$/;
            var mail=document.getElementById("email");
            var contact=document.getElementById("cntct");
            var username=document.getElementById("usrnam");
            ...
            username = document.forms["form1"]["usernam"];
            if (username.value == "")
            {
            ...
            {
                alert("User name cannot be greater than 20 characters.");
                x.value = "";
                x.focus();
            ...
            x = document.forms["form1"]["contctno"];
            if ( == "")
            {
            ...
            else if (!ContctNopattern.test(x.value))
            {
            ...
            else if (!Enrollpattern.test(x.value))
            {
                alert("Enrollment number should contain only digits.");
                x.value = "";
                x.focus();
                return false;
            }
            ...
            {
                alert("Enrollment number should contain only 9 digits.");
                x.value = "";
                x.focus();
                return false;
            }
...
<!-- register -->
	<div class="login">
		<div class="container">
			<h3>Register Now</h3>
                        <form action="regServ" method="post" name="form1" onsubmit="return validateForm()">
				<span class="input input--kuro">
					<input class="input__field input__field--kuro kuro_w3" type="text" name = "name" id="firstname" placeholder="" required="">
					<label class="input__label input__label--kuro" for="input-7">
						<span class="input__label-content input__label-content--kuro">Name</span>
                                ...
                                <span class="input input--kuro">
                                    <input class="input__field input__field--kuro kuro_w3" type="text" name= "contact" id="contctno" placeholder="" required="">
					<label class="input__label input__label--kuro" for="input-8">
						<span class="input__label-content input__label-content--kuro">Contact No.</span>
					</label>
				</span>
                            
				<span class="input input--kuro">
					<input class="input__field input__field--kuro kuro_w3" type="email" name="email" id="email" placeholder="" required="">
					<label class="input__label input__label--kuro" for="input-9">
						<span class="input__label-content input__label-content--kuro">Email Address</span>
                                ...
                                <span class="input input--kuro">
                                    <input class="input__field input__field--kuro kuro_w3" type="text" name="username" id="usernam" placeholder="" required="">
				...
				<span class="input input--kuro">
					<input class="input__field input__field--kuro kuro_w3" type="password" name="password" id="input-10" placeholder="" required="">
					<label class="input__label input__label--kuro" for="input-11">
						<span class="input__label-content input__label-content--kuro">Password</span>
                            ...
                            <span class="input input--kuro">
					<input class="input__field input__field--kuro kuro_w3" type="text" name="address" id="input-10" placeholder="" required="">
					<label class="input__label input__label--kuro" for="input-12">
						<span class="input__label-content input__label-content--kuro">Address</span>
					</label>
				</span>
