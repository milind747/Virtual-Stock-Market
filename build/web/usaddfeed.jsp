...
<html lang="en">
    ...
    <body>
        ...
        <!-- //banner-bottom -->
        <!-- equity -->
        <%--  <form action="addfeedServ" method="post">

            Name : <input type="text" name="name" value="" required=""><br></br>
            Email ID : <input type="text" name="email" value=""><br></br>
            Phone No. : <input type="text" name="phone" value="" ><br></br>
            Message : <input type="text" name="feedback" value="" required=""> <br><br>
				...
				<form action="addfeedServ" method="post">
					<div class="col-md-6 wthree_contact_left_grid">
						<span class="input input--kuro">
							<input class="input__field input__field--kuro" type="text" name="name" id="input-7" placeholder="" required="">
							<label class="input__label input__label--kuro" for="input-7">
								<span class="input__label-content input__label-content--kuro">Name</span>
							</label>
						</span>
						<span class="input input--kuro">
							<input class="input__field input__field--kuro" type="email" name="email" id="input-8" placeholder="" required="">
						...
						<span class="input input--kuro">
							<input class="input__field input__field--kuro" type="text" name="phone" id="input-9" placeholder="" required="">
