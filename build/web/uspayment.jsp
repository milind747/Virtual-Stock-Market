    ...
    <br><br>  
        <%
            if (session.getAttribute("al") != null) {
                ...
                Money od = (Money) session.getAttribute("al");
        %>
        <form name="paypalForm" action="https://www.sandbox.paypal.com/cgi-bin/webscr" method="post">
            <input type="hidden" name="cmd" value="_xclick" />
            
            <input type="hidden" name="item_name" value="">
            Product : <input type="text" name="pitem_name" value="Virtual Money" readonly="readonly" disabled="disabled" />
            
            
<!--            <input type="hidden" value="" name="quantity">
            Quantity:<input type="text" value="" name="pquantity" readonly="readonly" disabled="disabled"/><br>
            -->
            
            <input type="hidden" value="<%=od.getRealmoney()%>" name="amount">
            Price:<input type="text" value="<%=od.getRealmoney()%>" name="pamount" readonly="readonly" disabled="disabled" /><br><br><br>
            
            <input type="hidden" name="business" value="milindpatel3012-facilitator@gmail.com" />
            <input type="hidden" name="rm" value="2" />
            <input type="hidden" name="custom" value="<%=od.getMid()%>" />
            <input name = "currency_code" value = "USD" type = "hidden">
            <input type="image" src="https://www.sandbox.paypal.com/en_US/i/btn/btn_buynowCC_LG.gif" border="0" name="submit" alt="PayPal - The safer, easier way to pay online!">
            <input type="hidden" name="return" value="http://localhost:8085/vsm1/SaveTransactionServ" />
            <input type="hidden" name="cancel_return" value="http://localhost:8085/vsm1/paypalResponseCancel.jsp" />
        </form>
<%}%>
    <br><br>
