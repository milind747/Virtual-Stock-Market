							...
							<table class="w3_agile_all_trade w3_agile_all_trade_funds w3_table_trade">
								<tr>
									<th class="w3_agileits_head"><b>Stock Name</b></th>
                                                                        <td class="w3_agileits_head1"><b>Rate</b></td>
									<td class="w3_agileits_head1"><b>Quantity</b></td>
									<td class="w3_agileits_head1"><b>Total Amount</b></td>
									<td class="w3_agileits_head1"><b>Date & Time</b></td>
                                                                ...
                                                                <%
                                                                        ...
                                                                        al = (ArrayList<Boughtstock>) request.getAttribute("al1");
                                                                        for (Boughtstock b : al) {%>
								
                                                                               
                                                                <tr>
									<th class="w3_agile_th">
										<a href="single.html"><%=b.getSid().getName()%></a>
									</th>
									
                                                                        <td class="agileits_w3layouts_td"><%=b.getSid().getPrice()%></td>
									<td class="agileits_w3layouts_td"><%=b.getQty()%></td>
                                                                        <td class="agileits_w3layouts_td"><%=b.getTotalamt()%></td>
									<td class="agileits_w3layouts_td"><%=b.getBuydate()%></td>
                                                                        <td><a href="fetchsellserv?id1=<%=b.getBuyid()%>"><input type="button" value="Sell"></a></td>
								</tr>
                                                                <%}
...
<form>
            ...
            <table border="1" style="text-align: center; width: 100%">
                <tr>
                    ...
                    <td><%=b.getSid().getName()%></td>
                    <td><%=b.getSid().getPrice()%></td>
                    <td><%=b.getQty()%></td>
                    <td><%=b.getTotalamt()%></td>
                    <td><%=b.getBuydate()%></td>
                    <td><a href="fetchsellserv?id1=<%=b.getBuyid()%>"><input type="button" value="Sell"></a></td>
