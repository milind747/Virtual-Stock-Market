    ...
    <body>
        ...
        <script type="text/javascript" >
                ...
                function calc() {
                    ...
                    var b = document.getElementById("sqty").value;
        ...
        <div class="w3l_your_stocks">
						<h3><i class="fa fa-stack-exchange" aria-hidden="true"></i>Sell Stocks</h3>
						<form action="finalsellServ" method="get">
                                                    
                                                    <%
                                                        ArrayList<Boughtstock> al;
                                                        if (request.getAttribute("al") != null) {
                                                        al = (ArrayList<Boughtstock>) request.getAttribute("al");
                                                        for (Boughtstock b : al) {%>
                                                        
                                                        <input type="text" name="id" hidden value="<%=b.getBuyid()%>" >
                                                        
							<span>
								<label>Stock Name</label>
								<input type="text" name="stockname" value=" <%=b.getSid().getName()%>" readonly="">
							</span>
							<span>
								<label>Current Price</label>
								<input type="text" name="curprice" id="price" value="<%=b.getSid().getPrice()%>">
							</span>
							<span>
								<label>Avaliable Quantity</label>
								<input type="text" name="aqty" id="aqty" value="<%=b.getQty()%>" readonly="">
							</span>
                                                        <input type="hidden" name="oneprice" value="<%=b.getSid().getPrice()%>">
							<span>
								<label>Sell Quantity</label>
								<input type="text" name="sqty" id="sqty" >
							</span>
							<span>
								<label>Total Amount</label>
								<input type="text" name="totamt" id = "ta" value="">
							</span>
                                                        <br>
							<input style="height:40px;width:200px" type="submit" value="Calculate" onclick="return calc()"><br><br>
                                                        <input style="height:40px;width:200px" type="submit" value="Sell" onclick="return validate()"><br>
						<% }
        ...
        <form action="finalsellServ" method="get">
            ...
            Stock name : <input type="text" name="stockname" value=" <%=b.getSid().getName()%>" readonly=""><br>
            Current price : <input type="text" name="curprice" id="price" value="<%=b.getSid().getPrice()%>"><br>
            Available Quantity : <input type="text" name="aqty" id="aqty" value="<%=b.getQty()%>" readonly=""><br>
            <input type="hidden" name="oneprice" value="<%=b.getSid().getPrice()%>">
            Sell Quantity : <input type="text" name="sqty" id="sqty" ><br>
            Total amount : <input type="text" name="totamt" id = "ta" value=""><br>
            <input type="submit" value="Calculate" onclick="return calc()"><br><br>
            <input type="submit" value="Sell" onclick="return validate()"><br>
