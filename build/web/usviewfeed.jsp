...
<div class="w3_equity_market_analysis_grid_sub">
						...
						<div class="w3_agileits_gain_list">
							<table class="w3_agile_all_trade w3_agile_all_trade_funds w3_table_trade">
								<tr>
									<th class="w3_agileits_head"><b>Name</b></th>
									<td class="w3_agileits_head1"><b>Email ID</b></td>
									<td class="w3_agileits_head1"><b>Contact No.</b></td>
									<td class="w3_agileits_head1"><b>Message</b></td>
									...
									<th class="w3_agile_th">
										<a href="single.html"><%=cf.getName()%></a>
									</th>
									
									<td class="agileits_w3layouts_td"><%=cf.getEmailid()%></td>
									<td class="agileits_w3layouts_td"><%=cf.getContactno()%></td>
									<td class="agileits_w3layouts_td"><%=cf.getFeedback()%></td>
        ...
        <form>
             <table border="1" style="text-align: center">
                ...
                <tr>
                    ...
                    <b><td><%=cf.getName()%></td></b>
                    <td><%=cf.getEmailid()%></td>
                    <td><%=cf.getContactno()%>.</td>
                    <td><%=cf.getFeedback()%></td>
                </tr>
                <%}
