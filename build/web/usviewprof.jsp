...
<div class="w3l_your_stocks">
						...
						<form>
                                                    ...
                                                    <%
                                                        ...
                                                        <span>
								<label>Name</label>
								<input type="text" name="name" value="<%=r.getName()%>" readonly="">
							</span>
							<span>
								<label>Email ID</label>
								<input type="text" name="email" value="<%=r.getEmailid()%>" readonly="">
							</span>
							<span>
								<label>Address</label>
								<input type="text" name="address" value="<%=r.getAddress()%>" readonly="">
							</span>
                                                       
							<span>
								<label>Contact Number</label>
								<input type="text" name="contact" value="<%=r.getContact()%>" readonly="">
							</span>
							
                                                        <br>
                                                        <a href="profeditServ?id=<%=r.getRid()%>"><input style="height:40px;width:200px" type="button" value="Edit" ></a><br><br>
                                                        <a href="prolosscalServ"><input style="height:40px;width:200px" type="button" value="My Profit/Loss statement"></a>
						<% }
	  ...
	  <form>
              ...
              <table border="1" style="text-align: center">
                ...
                <tr>
                    ...
                    <td><%=r.getAddress()%></td>
                    <td><%=r.getContact()%></td>
                    <td><a href="profeditServ?id=<%=r.getRid()%>"><input type="button" value="Edit"></a></td>
                ...
                <br<br><br>
                <a href="prolosscalServ"><input type="button" value="Profit/Loss statement"></a>
