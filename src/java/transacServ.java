...
public class transacServ extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
                ...
                Criteria cr = se.createCriteria(Soldstock.class);
                cr.add(Restrictions.eq("loginid", l));
                ArrayList<Soldstock> al = (ArrayList<Soldstock>) cr.list();
                request.setAttribute("al", al);
                tr.commit();

                RequestDispatcher rd = request.getRequestDispatcher("ustrans.jsp");
