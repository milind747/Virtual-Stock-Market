...
<html lang="en">
<head>
<title>Trade Market a Corporate Business Category Flat Bootstrap Responsive Website Template | About Us :: w3layouts</title>
<!-- for-mobile-apps -->
			...
			<div class="agileinfo_news_original_grids w3_agile_news_market_grids">
				<div class="col-md-9 w3ls_mutual_funds_grid1_jkjk">
					<div class="agileits_about_grids w3ls_products_grid">
						<h3>About Trade Market</h3>
						<div class="agileits_about_grid">
							<div class="col-md-5 agileits_about_grid_left">	
								<img src="images/35.jpg" alt=" " class="img-responsive" />
							</div>
							<div class="col-md-7 agileits_about_grid_right">
								<p>Aliquam sed libero at mi bibendum pretium quis in lacus. Integer 
									malesuada lectus eu orci pellentesque, a malesuada est tristique. 
									Fusce porta pretium arcu vitae tincidunt. Vivamus rutrum ipsum id 
									euismod iaculis. Etiam finibus purus quis est elementum, id congue 
									urna faucibus. Suspendisse orci lectus, vehicula ullamcorper. <span>Suspendisse dictum sodales erat, 
									eget pulvinar dolor. Aenean eu sapien ante. Pellentesque rutrum 
									malesuada magna.</span></p>
							</div>
							<div class="clearfix"> </div>
							<p>Duis nec bibendum nunc. Nam blandit nibh a est finibus, et tincidunt nibh 
								sollicitudin. Duis cursus ante sit amet libero varius, sit amet aliquet nibh 
								fermentum.Nam consequat, libero at lobortis auctor, sapien neque auctor elit, at 
								feugiat urna tortor sed ipsum.</p>
						</div>
						<div class="agileinfo_trade_team">
							<h5><i class="fa fa-users" aria-hidden="true"></i>Board of Directors</h5>
							<div class="col-md-3 agileinfo_trade_team_grid">
								<div class="agileinfo_trade_team_grid1">
									<div class="agile_chat_grid1">
										<img src="images/49.jpg" alt=" " class="img-responsive">
										<div class="agile_p_mask agile_p_mask_team">
											<ul>
									...
									<div class="agileinfo_trade_team_agile">
										<h6>Mark Levis</h6>
										<p>Chairman</p>
									</div>
								</div>
