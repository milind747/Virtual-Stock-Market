...
<html lang="en">
<head>
<title>Trade Market a Corporate Business Category Flat Bootstrap Responsive Website Template | FAQ :: w3layouts</title>
<!-- for-mobile-apps -->
		...
		<div class="container">
			...
			<div class="w3l_faq_grids">
				<div class="w3l_faq_grid">
					<h4>1. Maecenas consequat libero eu eleifend placerat ?</h4>
					<p>Cras orci ex, porta et dui vitae, gravida sagittis ligula. 
						Phasellus ullamcorper quam nisi. Quisque ipsum neque, fringilla 
						at sagittis sit amet, egestas et tellus. Pellentesque lacinia 
						facilisis massa quis semper.</p>
				</div>
				<div class="w3l_faq_grid">
					<h4>2. Phasellus ullamcorper quam nisi placerat ?</h4>
					<p>Cras orci ex, porta et dui vitae, gravida sagittis ligula. 
						Phasellus ullamcorper quam nisi. Quisque ipsum neque, fringilla 
						at sagittis sit amet, egestas et tellus. Pellentesque lacinia 
						facilisis massa quis semper.</p>
				...
				<div class="w3l_faq_grid">
					<h4>3. gravida sagittis ligula porta et dui vitae ?</h4>
					<p>Cras orci ex, porta et dui vitae, gravida sagittis ligula. 
						Phasellus ullamcorper quam nisi. Quisque ipsum neque, fringilla 
						at sagittis sit amet, egestas et tellus. Pellentesque lacinia 
						facilisis massa quis semper.</p>
				...
				<div class="w3l_faq_grid">
					<h4>4. Vestibulum dapibus, magna quis finibus scelerisque ?</h4>
					<p>Cras orci ex, porta et dui vitae, gravida sagittis ligula. 
						Phasellus ullamcorper quam nisi. Quisque ipsum neque, fringilla 
						at sagittis sit amet, egestas et tellus. Pellentesque lacinia 
						facilisis massa quis semper.</p>
				...
				<div class="w3l_faq_grid">
					<h4>5. Suspendisse augue enim, rhoncus eu velit id ?</h4>
					<p>Cras orci ex, porta et dui vitae, gravida sagittis ligula. 
						Phasellus ullamcorper quam nisi. Quisque ipsum neque, fringilla 
						at sagittis sit amet, egestas et tellus. Pellentesque lacinia 
						facilisis massa quis semper.</p>
				...
				<div class="w3l_faq_grid">
					<h4>6. Cras orci ex, porta et dui vitae, gravida sagittis ?</h4>
					<p>Cras orci ex, porta et dui vitae, gravida sagittis ligula. 
						Phasellus ullamcorper quam nisi. Quisque ipsum neque, fringilla 
						at sagittis sit amet, egestas et tellus. Pellentesque lacinia 
						facilisis massa quis semper.</p>
				...
				<div class="w3l_faq_grid">
					<h4>7. Fusce nulla turpis, tempor at auctor et, dignissim ?</h4>
					<p>Cras orci ex, porta et dui vitae, gravida sagittis ligula. 
						Phasellus ullamcorper quam nisi. Quisque ipsum neque, fringilla 
						at sagittis sit amet, egestas et tellus. Pellentesque lacinia 
						facilisis massa quis semper.</p>
