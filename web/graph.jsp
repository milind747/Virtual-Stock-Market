...
<html lang="en">
    ...
    <body>
        ...
        <form action="graphServ" method="post" id="formid">
            
            <br><br>
            Please Enter Stock Symbol to view Graphical Analysis:
        ...
        <br><br> <div style="text-align:center">
            <% String link = "https://chart.finance.yahoo.com/z?s=GOOGL&amp;t=1d&amp;q=&amp;l=&amp;z=l&amp;a=v&amp;p=s&amp;lang=en-IN&amp;region=IN";
                if (request.getAttribute("link") != null) {
                    link = (String) request.getAttribute("link");
                }%> 
            <img style="-webkit-user-select: none; cursor: zoom-in;" src="<%= link%>" width="757" height="450">
        </div>
