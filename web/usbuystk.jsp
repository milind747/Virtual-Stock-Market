    ...
    <body>
        ...
        <script type="text/javascript" >
            function validate() {
                ...
                var am = document.getElementById("am1").value;

                if (Number(am) < Number(ta))
                {
        ...
        <div class="w3l_your_stocks">
						<h3><i class="fa fa-stack-exchange" aria-hidden="true"></i>Buy Stocks</h3>
						<form action="finalbuyserv" method="post" id="formid">
                                                    
                                                    <% ArrayList<Registration> al2;
                                                        if (request.getAttribute("al2") != null) {
                                                        al2 = (ArrayList<Registration>) request.getAttribute("al2");
                                                        for (Registration r : al2) {%>
                                                        <span>
								<label>Available money</label>
								<input type="text" name="am" id="am1" value="<%=r.getMoney()%>"> <br>
							</span>
                                                    ...
                                                    <%
                                                        ...
                                                        <input type="hidden" name="sid" value="<%=s.getSid()%>" readonly="">
							...
							<span>
								...
								<input type="text" name="curprice" id="price" value="<%=s.getPrice()%>" readonly="">
							</span>
                                                        <input type="hidden" name="openprice" id="price" value="<%=s.getPrice()%>" readonly="">
							<span>
							...
							<input style="height:40px;width:200px" type="submit" value="Calculate" onclick="return calc()"><br><br>
                                                        <input style="height:40px;width:200px" type="submit" value="Buy" onclick="return validate()"><br>
						<% }
        ...
        <form action="finalbuyserv" method="post" id="formid">
            <% ArrayList<Registration> al2;
                if (request.getAttribute("al2") != null) {
                    al2 = (ArrayList<Registration>) request.getAttribute("al2");
                    for (Registration r : al2) {%>
            Available money : <input type="text" name="am" id="am1" value="<%=r.getMoney()%>"> <br>
            ...
            Current price : <input type="text" name="curprice" id="price" value="<%=s.getPrice()%>" readonly=""><br>
            <input type="hidden" name="openprice" id="price" value="<%=s.getPrice()%>" readonly="">
            Quantity : <input type="text" name="qty" id="qty" value="1" ><br>
            Total amount : <input type="text" name="totamt" id="ta" value=""><br>
            <input style="height:40px;width:200px" type="button" value="Calculate" onclick="return calc()"><br><br>
            <input style="height:40px;width:200px" type="submit" value="Buy" onclick="return validate()"><br>
