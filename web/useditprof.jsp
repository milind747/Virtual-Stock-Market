...
jQuery(document).ready(function ($) {
    ...
    <body>
        ...
        <div class="w3l_your_stocks">
						<h3><i class="fa fa-stack-exchange" aria-hidden="true"></i>Sell Stocks</h3>
                                               ...
                                               %>
                                                ...
                                                <form action="profupdateServ" method="post">
                                                    
                                                   <input type="hidden" value="<%=r.getRid()%>" name="rid">
                                                   <input type="hidden" value="<%=r.getLoginid()%>" name="lid">
                                                        
                                                        <span>
								<label>Name</label>
								<input type="text" name="name" value="<%=r.getName()%>" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'name';}" required="">
							</span>
							<span>
								<label>Email ID</label>
								<input type="text" name="email" value="<%=r.getEmailid()%>" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'email';}" required="">
							</span>
							<span>
								<label>Address</label>
								<input type="text" name="address" value="<%=r.getAddress()%>" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'address';}" required="">
							</span>
                                                       
							<span>
								<label>Mobile Number</label>
								<input type="text" name="contact" value="<%=r.getContact()%>" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'contact';}" required="">
							</span>
							<input type="hidden" name="money" value="<%=r.getMoney()%>" ><br><br>
                                                     
							<input style="height:40px;width:200px" type="submit" value="Update" ><br>
        ...
        <form action="profupdateServ" method="post">
            ...
            Mobile number:&nbsp;&nbsp;<input type="text" name="contact" value="<%=r.getContact()%>" onfocus="this.value = '';" onblur="if (this.value == '') {
                        this.value = 'contact';
                    }" required=""><br><br>
