							...
							<table class="w3_agile_all_trade w3_agile_all_trade_funds w3_table_trade">
								<tr>
									<th class="w3_agileits_head"><b>Stock Name</b></th>
                                                                        <td class="w3_agileits_head1"><b>Rate when stock sold</b></td>
									...
									<td class="w3_agileits_head1"><b>Date & Time</b></td>
                                                                ...
                                                                <%
                                                                        ArrayList<Soldstock> al;
                                                                        if (request.getAttribute("al") != null) {
                                                                        al = (ArrayList<Soldstock>) request.getAttribute("al");
                                                                        for (Soldstock s : al) {%>
								
                                                                               
                                                                <tr>
									<th class="w3_agile_th">
										<a href="single.html"><%=s.getSid().getName()%></a>
									</th>
									
                                                                        <td class="agileits_w3layouts_td"><%=s.getSid().getPrice()%></td>
									<td class="agileits_w3layouts_td"><%=s.getQty()%></td>
                                                                        <td class="agileits_w3layouts_td"><%=s.getTotalamt()%></td>
									<td class="agileits_w3layouts_td"><%=s.getSelldate()%></td>
                ...
                <tr>
                    <%
                        ...
                        if (request.getAttribute("al") != null) {
                            ...
                            for (Soldstock s : al) {%>
                <tr>
                    <td><%=s.getSid().getName()%></td>
                    <td><%=s.getSid().getPrice()%></td>
                    <td><%=s.getQty()%></td>
                    <td><%=s.getTotalamt()%></td>
                    <td><%=s.getSelldate()%></td>
