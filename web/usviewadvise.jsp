							...
							<table class="w3_agile_all_trade w3_agile_all_trade_funds w3_table_trade">
								<tr>
									<th class="w3_agileits_head"><b>Stock Name</b></th>
                                                                        <td class="w3_agileits_head1"><b>User Name</b></td>
									<td class="w3_agileits_head1"><b>Email ID</b></td>
									<td class="w3_agileits_head1"><b>Advise</b></td>
									<td class="w3_agileits_head1"><b>Date</b></td>
                                                                ...
                                                                <%
                                                                        ...
                                                                        al = (ArrayList<Advise>) request.getAttribute("al");
                                                                        for (Advise a : al) {%>
								
                                                                               
                                                                <tr>
									<th class="w3_agile_th">
										<a href="single.html"><%=a.getStockname()%></a>
									</th>
									
									<td class="agileits_w3layouts_td"><%=a.getUsername()%></td>
									<td class="agileits_w3layouts_td"><%=a.getEmailid()%></td>
									<td class="agileits_w3layouts_td"><%=a.getAdvise()%></td>
                                                                        <td class="agileits_w3layouts_td"><%=a.getAdvisedate()%></td>
                ...
                <tr>
                    <%
                        ...
                        if (request.getAttribute("al") != null) {
                            ...
                            for (Advise a : al) {%>
                <tr>
                    <td><%=a.getStockname()%></td>
                    <td><%=a.getUsername()%></td>
                    <td><%=a.getEmailid()%></td>
                    <td><%=a.getAdvise()%></td>
                    <td><%=a.getAdvisedate()%></td>
