...
<!-- equity -->
    <div class="w3_equity_market_analysis_grid_sub">
                                                <br>
						<h4>VIRTUAL CURRENCY PRICE TABLE</h4>
                                                <br>
                                                
						<div class="w3_agileits_gain_list">
							<table class="w3_agile_all_trade w3_agile_all_trade_funds w3_table_trade">
								<tr>
									<th class="w3_agileits_head"><b>Price in $</b></th>
                                                                        <td class="w3_agileits_head1"><b>Virtual Currency</b></td>
									<td class="w3_agileits_head1"><b>Action</b></td>
                                                                ...
                                                                <%
                                                                        ...
                                                                        al = (ArrayList<Money>) request.getAttribute("al");
                                                                        for (Money m : al) {%>
								
                                                                               
                                                                <tr>
									<th class="w3_agile_th">
										<a href="single.html"><%=m.getRealmoney()%></a>
									</th>
                                                                        <td class="agileits_w3layouts_td"><%=m.getVirtualmoney()%></td>
									<td><a href="paymentServ?id=<%=m.getMid()%>"><input type="button" value="Buy"></a></td>
        ...
        <form>
             <table border="1" style="text-align: center">
                ...
                <tr>
                    ...
                    <b><td><%=m.getRealmoney()%></td></b>
                    <td><%=m.getVirtualmoney()%></td>
                    <td><a href="paymentServ?id=<%=m.getMid()%>"><input type="button" value="Buy"></a></td>
