        ...
        <div class="w3_equity_market_analysis_grid_sub">
						...
						<div class="w3_agileits_gain_list">
							<table class="w3_agile_all_trade w3_agile_all_trade_funds w3_table_trade">
								<tr>
									<th class="w3_agileits_head"><b>Stock Symbol</b></th>
                                                                        <td class="w3_agileits_head1"><b>Stock Name</b></td>
                                                                        <td class="w3_agileits_head1"><b>Current Rate</b></td>
									<td class="w3_agileits_head1"><b>High</b></td>
									<td class="w3_agileits_head1"><b>Low</b></td>
									<td class="w3_agileits_head1"><b>Change</b></td>
                                                                        <td class="w3_agileits_head1"><b>Change in %</b></td>
									<td class="w3_agileits_head1"><b>Action</b></td>
                                                                        <td class="w3_agileits_head1"><b>Watchlist</b></td>
								</tr>
                                                                ...
                                                                <%
                                                                        ...
                                                                        al = (ArrayList<SharedetailNew>) request.getAttribute("al");
                                                                        for (SharedetailNew s : al) {%>
								
                                                                               
                                                                <tr>
									<th class="w3_agile_th">
										<a href="single.html"><%=s.getSymbol()%></a>
									</th>
									
                                                                        <td class="agileits_w3layouts_td"><%=s.getName()%></td>
									<td class="agileits_w3layouts_td"><%=s.getPrice()%></td>
                                                                        <td class="agileits_w3layouts_td"><%=s.getHigh()%></td>
									<td class="agileits_w3layouts_td"><%=s.getLow()%></td>
                                                                        <td class="agileits_w3layouts_td"><%=s.getChange1()%></td>
                                                                        <td class="agileits_w3layouts_td"><%=s.getChangeinpercentage()%></td>
                                                                        <td><a href="buystockserv?id1=<%=s.getSid()%>"><input type="button" value="Buy"></a></td>
                                                                        <td><a href="watchlistServ?id1=<%=s.getSid()%>"><input type="button" value="Add to Watchlist"></a></td>
                                                                </tr>
                                                                <%}
