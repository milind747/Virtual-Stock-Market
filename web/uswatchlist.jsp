	  ...
	  <div class="w3_equity_market_analysis_grid_sub">
						...
						<div class="w3_agileits_gain_list">
							<table class="w3_agile_all_trade w3_agile_all_trade_funds w3_table_trade">
								<tr>
									<th class="w3_agileits_head"><b>Stock Name</b></th>
									...
									<td class="w3_agileits_head1"><b>Action</b></td>
                                                                ...
                                                                <%
                                                                        ArrayList<Watchlist> al;
                                                                        if (request.getAttribute("al") != null) {
                                                                        al = (ArrayList<Watchlist>) request.getAttribute("al");
                                                                        for (Watchlist w : al) {%>
								
                                                                               
                                                                <tr>
									<th class="w3_agile_th">
										<a href="single.html"><%=w.getSid().getName()%></a>
									</th>
									
                                                                        <td class="agileits_w3layouts_td"><%=w.getSid().getPrice()%></td>
									<td class="agileits_w3layouts_td"><%=w.getSid().getHigh()%></td>
                                                                        <td class="agileits_w3layouts_td"><%=w.getSid().getLow()%></td>
									<td class="agileits_w3layouts_td"><%=w.getSid().getChange1()%></td>
                                                                        <td class="agileits_w3layouts_td"><%=w.getSid().getChangeinpercentage()%></td>
                                                                        <td><a href="removefromwlServ?id1=<%=w.getWlistid()%>"> <input type="button" value="Remove from watchlist"></a></td>
								</tr>
                                                                <%}
                ...
                <tr>
                    <%
                        ...
                        if (request.getAttribute("al") != null) {
                            ...
                            for (Watchlist w : al) {%>
                <tr>
                    <td><%=w.getSid().getName()%></td>
                    <td><%=w.getSid().getPrice()%></td>
                    <td><%=w.getSid().getHigh()%></td>
                    <td><%=w.getSid().getLow()%></td>
                    <td><%=w.getSid().getChange1()%></td>
                    <td><%=w.getSid().getChangeinpercentage()%></td>
                    <td><a href="removefromwlServ?id1=<%=w.getWlistid()%>"> <input type="button" value="Remove from watchlist"></a></td>
